...
$string ['oneOfBin_help'] = 'Hier können Sie eine Auswahlfrage inkl. Antwortoptionen angeben, welche bei der Gruppenbildung berücksichtigt wird, z.B. Was ist Ihr Studienfach?';
$string ['oneOfBinQuestion'] = 'Eine Auswahlfrage soll in die Gruppenbildung einfließen.';
...
$string ['homogeneous'] = 'Homogen';
$string ['heterogeneous'] = 'Heterogen';
$string ['choose_oob_answers'] = 'Bitte geben Sie eine Auswahlfrage (z.B. Was ist Ihr Studienfach?) an:';
$string ['add_oob_question'] = 'Wie lautet Ihre Auswahlfrage?';
$string ['answers'] = 'Antwortmöglichkeiten:';
$string ['importance'] = 'Gewichtung:';
$string ['choose_oob_importance'] = 'Bitte spezifieren Sie die Gewichtung der Frage (d.h. im Vergleich zu anderen Kriterien):';
$string ['relation'] = 'Ausprägung';
$string ['choose_oob_relation'] = 'Bitte wählen Sie die gewünsche Ausprägung für die Gruppenbildung aus:';
$string ['choose_answer'] = 'Beantworten Sie die folgende Auswahlfrage:';
$string ['choose_answers'] = 'Beantworten Sie die folgende (Mehrfach-)Auswahlfrage:';
$string ['no_oob_question'] = 'Es wurde noch keine Auswahlfrage angegeben.';
$string ['oob_selected_value'] = 'Ausgewählt: ';
